...
export default function ProfilePage() {
  ...
  const handleSave = async () => {
    ...
    setLoading(false);
    setSaved(true);
    setTimeout(() => router.push('/create-ad'), 1200);
  };
      ...
      <div style={{ maxWidth: '520px', margin: '0 auto', padding: '3rem 2rem' }}>
        ...
        <div style={{ background: '#111', border: '1px solid #1a1a1a', borderRadius: '16px', padding: '2.5rem' }}>
          ...
          <textarea
            ...
            placeholder="e.g. We help Pi Network sellers reach more buyers through targeted ads..."
          ...
          <input
            ...
            placeholder="contact@yourbrand.com or @handle"
          ...
          <button
            onClick={handleSave}
            disabled={loading || saved || !form.bio}
            style={{ width: '100%', background: saved ? '#1a1a1a' : btnColor, color: saved ? '#0070f3' : '#fff', border: 'none', borderRadius: '8px', padding: '0.85rem', fontWeight: 600, fontSize: '1rem', cursor: loading || saved ? 'default' : 'pointer' }}
          >
