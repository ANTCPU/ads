// app/api/agents/feed/route.ts
// ─── Agent Feed — Arena data snapshot ────────────────────────────────────────
// Token-gated GET — returns full Arena state for agent context.
// Used by: Ledger (analytics), admin agent panel, future SDK.
//
// Moved from: /api/agent GET (Sep 2026)
