...
export default function VaultModal({
  ...
  const ghostBtn: React.CSSProperties = {
    ...
    marginTop: '0.5rem', cursor: 'pointer', padding: '0.25rem',
  };

  // ─── Source-derived display values ───────────────────────────────────────
  ...
  const headerIcon  = isTV ? (isTVPro ? '📡' : '👁') : (mode === 'signup' ? '⚡' : '🔒');
  const headerLabel = isTV
  ...
  const brandPlaceholder = isTVPro
    ? 'Channel or brand name (optional)'
    : 'Brand or shop name (optional)';

  const successMsg =
    isTVPro    ? 'Studio ready. Go live!'        :
    isTVViewer ? "You're in. Enjoy the stream."  :
    mode === 'signup' ? 'Welcome to the Arena!'  :
    'Access Granted';
      ...
      >
        ...
        {isTV && step === 'email' && (
          <div style={{
            ...
            background: `${tvAccent}08`, border: `1px solid ${tvAccent}25`,
            borderRadius: '10px',
          }}>
        ...
        {/* ── Mode toggle — email step only, not for tv-viewer ── */}
        ...
        {step === 'email' && (
          <>
            ...
            <button onClick={onClose} style={{ ...ghostBtn, marginTop: '0.75rem' }}>
              Cancel
            </button>
          </>
        )}
        ...
        {step === 'signup-details' && (
          <>
            ...
            <button onClick={() => { setStep('email'); setError(''); }} style={ghostBtn}>
              ← Back
            </button>
          </>
        )}
        ...
        {step === 'pin' && (
          <>
              ...
              <div style={{ position: 'relative', marginBottom: '0.75rem' }}>
                <input
                  ...
                  style={{
                    ...
                    letterSpacing: '0.25em', fontSize: '1.2rem', textAlign: 'center',
                  }}
                />
                <button
                  ...
                  style={{
                    ...
                    cursor: 'pointer', color: '#444', fontSize: '1rem',
            ...
            <button onClick={() => { setStep('email'); setPin(''); setError(''); setShowPin(false); }} style={ghostBtn}>
              ← Back
            </button>
          </>
        )}
