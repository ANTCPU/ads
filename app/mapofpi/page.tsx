...
const s: Record<string, React.CSSProperties> = {
  ...
  // FIX: statsBar is now a proper flex row — xlmPrice was previously outside this container
...
export default function MapOfPiSplash() {
  ...
  return (
    <div style={s.page}>
      ...
      {/* ── STATS BAR — FIXED: all 5 stats inside one flex container ── */}
      ...
      <div style={s.section}>
        <div style={s.partnerCard}>
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            <a href={MAPOFPI_KB.url} target="_blank" rel="noreferrer" style={{ ...s.ctaBtn, padding: '0.7rem 1.5rem', fontSize: '0.9rem' }}>Visit Map of Pi →</a>
            <a href="https://youtube.com/@mapofpi" target="_blank" rel="noreferrer" style={{ ...s.ctaSecond, padding: '0.7rem 1.5rem', fontSize: '0.9rem' }}>▶ YouTube</a>
            <a href="/mapofpi/icons/arena" style={{ ...s.ctaSecond, padding: '0.7rem 1.5rem', fontSize: '0.9rem', color: gold, borderColor: `${gold}40` }}>🗺️ Country Champions →</a>
          </div>
        </div>
      </div>
