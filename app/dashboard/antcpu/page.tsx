...
import { ANTCPU_KB, ANTCPU_SYSTEM_PROMPT } from '../../clients/antcpu/kb';
...
export default function Dashboard() {
  ...
  const [msgs, setMsgs] = useState([
    { role: 'agent', text: `ADS agent online. Client: ${ANTCPU_KB.name} — ${ANTCPU_KB.url}. 10 antbots standing by.`, time: '' },
  ]);
    ...
    <div style={s.page}>
      <nav style={s.nav}>
        ...
        <div style={s.client}>
          ...
          {ANTCPU_KB.name} · v{ANTCPU_KB.version}
        </div>
      </nav>
